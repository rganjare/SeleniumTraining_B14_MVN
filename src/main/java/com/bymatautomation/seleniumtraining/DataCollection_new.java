package com.bymatautomation.seleniumtraining;

import java.util.Hashtable;

public class DataCollection_new {
	
	String testDataSheetName;
	String testCaseName;
	ExcelReader excel;
	
	public DataCollection_new(ExcelReader excel, String testDataSheetName, String testCaseName) {
		this.excel = excel;
