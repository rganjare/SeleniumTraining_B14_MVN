...
public class PostInquiry002 extends TestBase { // 1 to 1 Mapping // CTRL+Shift+O
	

//	@Test (description = "description-loginToInstagramWithValidCred")
	public void postInquiry002() throws IOException {
//		
//		
//		test.pass("Staring Test case PostInquiry002" );
//		
...
//		CommonMethods.clickOnWebElement(or.getProperty("submitbtn"));
	...
	public void postInquiry002(Hashtable<String, String> ht) throws IOException {
		
		//test.info("Staring Test case " +testCaseName + "execution.");
